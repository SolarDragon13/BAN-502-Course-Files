...
```{r}
heart_disease <- read_csv("C:/Users/Glenn/Desktop/Grad School/BAN 502/Week 4/Classification assignment/heart_disease.csv")
```
...
```{r}
set.seed(12345) 
heart_split = initial_split(heart_disease, prop = 0.7, strata = HeartDisease) #70% in training
